            ...
            <React.Fragment key={step.number}>
              ...
              >
                <div style={{
                  ...
                  height: '40px',
                  borderRadius: '50%',
                  backgroundColor: isCompletedOrActive ? 'var(--accent-lima)' : 'var(--bg-card)',
                  color: isCompletedOrActive ? 'var(--black)' : 'var(--gray-text)',
                  border: isCompletedOrActive ? '1px solid var(--accent-lima)' : '1px solid var(--gray-mid)',
              ...
              {index < steps.length - 1 && (
                <div style={{
                  ...
                  maxWidth: '120px',
                  height: '4px',
                  backgroundColor: currentStep > step.number ? 'var(--accent-lima)' : 'var(--gray-mid)',
                  margin: '0 12px',
